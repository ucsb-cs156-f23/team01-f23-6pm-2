...
public class UniversityControllerTests {
  ...
  public void test_getUniversity() throws Exception {
    ...
    String universityName = "Harvard";
    when(mockUniversityQueryService.getJSON(eq(universityName))).thenReturn(fakeJsonResult);

    String url = String.format("/api/university/get?universityName=%s",universityName);
